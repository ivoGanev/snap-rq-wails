...
import { CollectionApiService, type Collection } from './collection.service';
import { ProjectApiService, type Project } from './project.service';
import { EnvironmentApiService, type Environment } from './environment.service';
import { EnvironmentVariableApiService, type EnvironmentVariable } from './environment-variable.service';
import { FavouriteApiService, type FavouriteCollection } from './favourite.service';
import { SelectionStateService } from './selection-state.service';
import { IconManifestService } from './icon-manifest.service';
import { TagApiService, type Tag } from './tag.service';
import * as EnvironmentService from '../../../../bindings/snap-rq/backend/services';

export type RightPanelMode = 'response' | 'edit';
export type SidebarSection = 'collections' | 'favourites' | 'tags';
